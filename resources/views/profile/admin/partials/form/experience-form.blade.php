<form
	method="POST"
	action="{{ $experience->id ? route('profile.admin.experiences.update', [$experience]) : route('profile.admin.experiences.store') }}"
...
>
	...
	<div class="row">
		...
		<div class="col-12">
			<div class="form-group">
				<img
					src="{{ $experience->company_logo ? asset('uploads/profile/companies/' . $experience->company_logo) : asset('uploads/defaults/no_image.png') }}"
