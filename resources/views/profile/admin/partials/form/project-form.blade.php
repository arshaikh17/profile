<form
	method="POST"
	action="{{ $project->id ? route('profile.admin.projects.update', [$project]) : route('profile.admin.projects.store') }}"
...
>
	...
	<div class="row">
			...
			<div class="form-group">
				...
				<div id="responsibilitiesRows">
					@forelse($project->responsibilities ?? [] as $responsibilityKey => $responsibility)
						@include("profile.admin.partials.form.responsibility-row", [
			...
			<div class="form-group">
				...
				<div class="row" id="skillTagsRows">
					@forelse($project->skill_tags as $skillTagKey => $skillTag)
						@include("profile.admin.partials.form.skill-tag-row", [
							"key"		 =>	$skillTagKey,
							"skills"	 =>	$skills,
							"skillTag"	 =>	$skillTag
						])
		...
		<div class="col-12 col-md-6">
			<div class="form-group">
				<img
					src="{{ $project->cover ? asset('uploads/profile/project_covers/' . $project->cover) : asset('uploads/defaults/no_image.png') }}"
			...
			<div class="form-group">
				...
				<div class="row" id="galleryItemRows">
					@forelse($project->gallery as $gallery)
						@include("profile.admin.partials.form.gallery-item-row", [
							"key"		 =>	$gallery->id,
							"gallery"	 =>	$gallery
						])
					@empty
