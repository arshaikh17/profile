<form
	method="POST"
	action="{{ $education->id ? route('profile.admin.educations.update', [$education]) : route('profile.admin.educations.store') }}"
...
>
	...
	<div class="row">
			...
			<div class="form-group">
				...
				<div id="majorsRows">
					@forelse(($education->majors ?? []) as $majorKey => $major)
						@include("profile.admin.partials.form.major-row", [
							"key"		 =>	$majorKey,
							"major"		 =>	$major
						])
					@empty
		...
		<div class="col-12">
			<div class="form-group">
				<img
					src="{{ $education->institute_logo ? asset('uploads/profile/educations/' . $education->institute_logo) : asset('uploads/defaults/no_image.png') }}"
