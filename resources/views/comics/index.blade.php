...
<div class="container">
	<div class="row">
		...
		<div class="col-12 col-sm-6 col-md-3 statistics-card">
			...
			<a href="{{ route('comics.admin.series.index') }}" class="btn btn-sm btn-dark mt-1 w-100">View</a>
		</div>
		<div class="col-12 col-sm-6 col-md-3 statistics-card">
			<div class="card">
				<div class="card-body bg-dark text-white">
			...
			<a href="{{ route('comics.admin.arcs.index') }}" class="btn btn-sm btn-dark mt-1 w-100">View</a>
		</div>
		<div class="col-12 col-sm-6 col-md-3 statistics-card">
			<div class="card">
				<div class="card-body bg-dark text-white">
