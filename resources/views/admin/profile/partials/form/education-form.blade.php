<form
	method="POST"
	action="{{ $education->id ? route('admin.profile.education.editPost', [$education]) : route('admin.profile.education.store') }}"
...
>
	...
	<div class="row">
			...
			<div class="form-group">
				...
				<div id="majorsRows">
					@forelse(($education->majors ?? []) as $majorKey => $major)
						@include("admin.profile.partials.form.major-row", [
							"key"		 =>	$majorKey,
							"major"		 =>	$major
						])
					@empty
		...
		<div class="col-12">
			<div class="form-group">
				<img
					src="{{ $education->institute_logo ? asset('uploads/education/' . $education->institute_logo) : asset('uploads/defaults/no_image.png') }}"
