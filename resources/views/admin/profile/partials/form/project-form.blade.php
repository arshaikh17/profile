<form
	method="POST"
	action="{{ $project->id ? route('admin.profile.project.editPost', [$project]) : route('admin.profile.project.store') }}"
...
>
	...
	<div class="row">
		...
		<div class="col-12 col-md-6">
			<div class="form-group">
				<img
					src="{{ $project->cover ? asset('uploads/project_cover/' . $project->cover) : asset('uploads/defaults/no_image.png') }}"
			...
			<div class="form-group">
				...
				<div class="row" id="galleryItemRows">
					@forelse($project->gallery as $gallery)
						@include("admin.profile.partials.form.gallery-item-row", [
							"key"		 =>	$gallery->id,
							"gallery"	 =>	$gallery
						])
					@empty
